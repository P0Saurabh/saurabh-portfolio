    ...
    <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-16 px-4">
      <div>
        ...
        <h2 className="text-4xl md:text-5xl font-black text-[#fcfaff] tracking-tight leading-none">
          Selected <span className="text-[#ea5c2a]">Projects</span>
        </h2>
      </div>

      <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#2a2a2a]/50 border border-[#2a2a2a] text-[10px] uppercase tracking-widest font-black text-[#ea5c2a] hover:bg-[#ea5c2a]/10 transition-colors cursor-default">
